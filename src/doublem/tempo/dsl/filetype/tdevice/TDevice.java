...
import doublem.tempo.dsl.FileDescriptor;
import doublem.tempo.dsl.TerminusFileDefinition;
import doublem.tempo.dsl.ltl.EntryPoint;
import doublem.tempo.dsl.ltl.ExitPoint;
import doublem.tempo.dsl.ltl.IDevCState;
import doublem.tempo.dsl.ltl.OrthoRegion;
import doublem.tempo.dsl.ltl.Violation;
...
public class TDevice extends FileDescriptor  {
	...
	protected void createBehaviorsDotFiles(IDevCState state) {
		doublem.tempo.dsl.ltl.Behavior behavior;
